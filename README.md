...
## Algorithm:
1.)Import the required libraries for data processing, visualization, and Random Forest Regression.

2.)Load the environmental sensor dataset, clean missing values, and convert the time column into datetime format.

3.)Perform feature engineering by extracting hour information and creating cyclic and lag features for prediction.

4.)Prepare the processed dataset by removing missing rows and selecting important input features.

5.)Split the dataset into training and testing sets for model training and evaluation.

6.)Train separate Random Forest Regressor models to predict temperature, PM2.5 pollution, and energy values.

7.)Evaluate the model performance, visualize predictions and feature importance, and predict future environmental conditions using the latest sensor data.
...
## Output:
<img width="1168" height="503" alt="image" src="https://github.com/user-attachments/assets/e255cf95-9646-4fb3-b258-3bbe2ff7b909" />
<img width="1177" height="418" alt="image" src="https://github.com/user-attachments/assets/4e7e579a-c834-4184-b542-1ffaf1ae69c1" />
<img width="1175" height="529" alt="image" src="https://github.com/user-attachments/assets/be7bd87c-fc36-480a-9d75-ba621db1d711" />
